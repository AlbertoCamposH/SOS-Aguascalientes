...
$('#noche').addClass('dark-mode');
$('#happy').addClass('dark-mode');
function darkmode(){
    $('body').addClass('dark-mode');
        ...
        $('h3').removeClass('text-muted');
        $('h4').addClass('dark-mode');
        $('h5').addClass('dark-mode');
        $('h5').removeClass('text-muted');
        $('p').addClass('dark-mode');
        $('#noche').removeClass('large text-muted');  
